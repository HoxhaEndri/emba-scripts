...
FIRMWARE_BASE_PATH="/home/endri/Firmware2020/Zyxel/"
LOG_PATH_BASE="/home/endri/LOGS2020/Zyxel"
...
firmadyne_checker() {
  ...
  export FIRMADYNE_DIR="$EXT_DIR""/firmadyne_orig"
...
firmae_checker() {
  ...
  mkdir -p "$LOG_PATH_AE"
  #EXT_DIR="./external"
  export FIRMAE_DIR="/home/m1k3/git-repos/FirmAE"
  local IID
  export NETWORK_MODE="NONE"
  export ICMP="not ok"
